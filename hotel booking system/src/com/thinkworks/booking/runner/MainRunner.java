...
import com.thinkworks.booking.dto.RoomType;
...
public class MainRunner {
    ...
    public static void main(String[] args) {
        ...
        Room r = new Room(101, RoomType.SUITE, 3, true);
        Room r1 = new Room(102, RoomType.FAMILY, 2, false);
        Room r2 = new Room(103, RoomType.DOUBLE, 4, true);

        Room[] rooms = {r, r1, r2};

        Guest guest = new Guest("hithaishi", "8723487893", "hitha@gmail.com", "iur39840", 2);
        Guest guest1 = new Guest("yogitha", "8765449870", "yogi@gmail.com", "bhs88233", 1);
        Guest guest2 = new Guest("hithaishi", "8378435897", "hithaishi@gmail.com", "iwq92832", 1);
